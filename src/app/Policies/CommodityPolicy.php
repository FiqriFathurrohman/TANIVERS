...
class CommodityPolicy
{
    ...
    {
        return $user->can('view_any_komuditas');
    }
    ...
    {
        return $user->can('view_komuditas');
    }
    ...
    {
        return $user->can('create_komuditas');
    }
    ...
    {
        return $user->can('update_komuditas');
    }
    ...
    {
        return $user->can('delete_komuditas');
    }
    ...
    {
        return $user->can('delete_any_komuditas');
    }
