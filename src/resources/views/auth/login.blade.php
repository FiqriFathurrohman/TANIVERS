    ...
    <div class="panel-right">
        <div class="form-card fade-up">
            ...
            <form action="{{ route('login') }}" method="POST" novalidate>
                ...
                <!-- Pembatas Pilihan (Or Divider) -->
                <div class="flex items-center my-5">
                    <div class="flex-grow h-px bg-gray-200"></div>
                    <span class="px-3 text-xs text-gray-400 uppercase tracking-wider font-semibold">atau</span>
                    <div class="flex-grow h-px bg-gray-200"></div>
                </div>

                <!-- Tombol Google Login Premium -->
                <a href="{{ route('login.google') }}" class="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-[#E5E9F0] hover:border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-semibold text-sm rounded-[40px] transition-all duration-200 shadow-sm active:scale-[0.99]">
