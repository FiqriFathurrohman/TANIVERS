...
<style>
    ...
    /* ========================================================
       FIX SEARCH MAP POPUP / LEAFLET GEOCODER
       ======================================================== */
    ...
    .leaflet-control-geocoder-form {
        ...
        box-shadow: 0 10px 25px -5px rgba(15, 110, 63, 0.28) !important;
    ...
    .leaflet-control-geocoder-alternatives {
        ...
        box-shadow: 0 18px 40px -12px rgba(15, 23, 42, 0.25) !important;
        font-family: 'Inter', sans-serif !important;
    ...
    .leaflet-popup-content-wrapper {
        ...
        box-shadow: 0 18px 40px -15px rgba(15, 23, 42, 0.35) !important;
    }
    ...
    .table-modern tbody tr:hover {
        background: rgba(15, 110, 63, 0.02);
    }

    .badge-green {
        background: linear-gradient(135deg, #e8f3ec 0%, #d1e8dc 100%);
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-200/60 pb-6">
        <div class="space-y-2">
            ...
            <p class="text-base text-slate-500 flex items-center gap-2">
                <i data-lucide="map" size="18" class="text-emerald-600"></i>
                Petakan batas area lahan pertanian Anda secara presisi dengan satelit.
            </p>
        </div>
            ...
            <div class="premium-card p-2 relative group">
                ...
                <div class="absolute bottom-6 left-6 z-[400] bg-white/95 backdrop-blur-md px-4 py-3 rounded-xl shadow-lg border border-white/50 pointer-events-none">
                    ...
                    <p class="text-xs text-slate-700 font-medium flex items-center gap-2">
                        <i data-lucide="mouse-pointer-click" size="14" class="text-emerald-600"></i>
                        Klik area peta berurutan membuat titik poligon lahan.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="premium-card p-6 h-full flex flex-col">
                <div class="mb-6">
                    ...
                    <p class="text-xs text-slate-500">
                        Lengkapi informasi lahan yang dipetakan.
                    </p>
                </div>
                ...
                <form action="{{ route('lahan.store') }}" method="POST" class="space-y-5 flex-grow">
                    ...
                    <div class="premium-input-group">
                        <label class="block text-xs font-bold text-slate-700 mb-2 flex items-center gap-1.5 uppercase tracking-wide">
                            <i data-lucide="tag" size="14" class="text-emerald-600"></i>
                            Nama Lahan
                        </label>
                    ...
                    <div class="premium-input-group">
                        <label class="block text-xs font-bold text-slate-700 mb-2 flex items-center gap-1.5 uppercase tracking-wide">
                            <i data-lucide="mountain" size="14" class="text-emerald-600"></i>
                            Jenis Tanah
                        </label>
                    ...
                    <div class="bento-grid mt-2">
                        <div class="bento-item">
                            <p class="text-[10px] uppercase font-bold text-slate-400 mb-1 flex items-center gap-1">
                                <i data-lucide="crosshair" size="10"></i>
                                Titik Sudut
                            </p>
                        ...
                        <div class="bento-item">
                            <p class="text-[10px] uppercase font-bold text-slate-400 mb-1 flex items-center gap-1">
                                <i data-lucide="scaling" size="10"></i>
                                Luas (m²)
                            </p>
                        ...
                        <div class="bento-item full-width">
                            <div class="flex items-start justify-between">
                                <div>
                                    <p class="text-[10px] uppercase font-bold text-slate-400 mb-1 flex items-center gap-1">
                                        <i data-lucide="map-pin" size="10"></i>
                                        Koordinat Acuan (Center)
                                    </p>
                                    <p id="weather-point" class="text-xs font-mono font-medium text-slate-600">
                                        Menunggu mapping...
                                    </p>
                                </div>

                                <div class="bg-emerald-50 p-1.5 rounded-lg text-emerald-600">
                                    <i data-lucide="satellite" size="16"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 space-y-3">
                        <button type="submit" id="btn-simpan" disabled class="btn-premium w-full">
                            <i data-lucide="save" size="18"></i>
                            Simpan Lahan
                        </button>

                        <button type="button" id="btn-reset" class="btn-outline-premium w-full">
        ...
        <div class="px-6 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/50">
            <div>
                <h2 class="text-xl font-bold text-slate-900 font-serif flex items-center gap-2">
                    <i data-lucide="layers" size="22" class="text-emerald-600"></i>
                    Portofolio Lahan
                </h2>
                <p class="text-sm text-slate-500 mt-1">
                    Daftar seluruh area yang telah Anda daftarkan di sistem.
                </p>
            </div>

            <span class="badge-green">
                <i data-lucide="database" size="14"></i>
                Total: {{ $lahans->count() }} Lahan
            </span>
        </div>
            ...
            <table class="table-modern">
                ...
                <tbody class="bg-white/40">
                    @forelse ($lahans as $lahan)
                        <tr>
                            <td class="text-center font-medium text-slate-400">
                                {{ $loop->iteration }}
                            </td>
                            ...
                            <td>
                                ...
                                <div class="text-xs text-slate-400 mt-0.5 flex items-center gap-1">
                                    <i data-lucide="waypoints" size="12"></i>
                                    {{ is_array($lahan->koordinat_lahan) ? count($lahan->koordinat_lahan) : 0 }} Titik Polygon
                                </div>
                            </td>
                            ...
                            <td>
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold border border-emerald-100">
                                    <i data-lucide="mountain" size="12" class="text-emerald-600"></i>
                                    {{ $lahan->jenis_tanah }}
                                </span>
                            </td>
                            ...
                            <td>
                                ...
                                @if($lahan->luas_meter_persegi >= 10000)
                                    <div class="text-[10px] font-bold text-emerald-500 uppercase mt-0.5">
                                        {{ number_format($lahan->luas_meter_persegi / 10000, 2) }} Hektar
                                    </div>
                                @endif
                            </td>
                            ...
                            <td>
                                <div class="text-sm font-medium text-slate-700">
                                    {{ $lahan->created_at->format('d M Y') }}
                                </div>
                                <div class="text-xs text-slate-400">
                                    {{ $lahan->created_at->format('H:i') }} WIB
                                </div>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-16 text-center">
                                <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-50 mb-4">
                                    <i data-lucide="map-x" size="32" class="text-slate-300"></i>
                                </div>
                                ...
                                <p class="text-slate-500 text-sm max-w-sm mx-auto">
                                    Anda belum mendaftarkan lahan apapun. Silakan gunakan peta di atas untuk mulai memetakan lahan pertama Anda.
                                </p>
                            </td>
                        </tr>
                    @endforelse
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        .on('markgeocode', function(e) {
            ...
            L.popup({
                ...
                autoClose: true,
                closeOnClick: true,
                className: 'premium-search-popup'
            })
            .setLatLng(e.geocode.center)
            .setContent(`
                <div style="min-width: 180px;">
                    <div style="font-weight: 800; color: #064E3B; margin-bottom: 4px;">
                        Hasil Pencarian
                    </div>
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(pos) {
                ...
                .addTo(map)
                .bindPopup("<b>📍 Lokasi Anda Saat Ini</b><br>Berdasarkan GPS Perangkat")
                .openPopup();
            }, function(error) {
        ...
        function updateDisplay() {
            ...
            setTimeout(() => {
                titikCount.classList.remove('scale-110', 'text-emerald-600');
            }, 200);
