...
<head>
    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6">
        <nav class="flex items-center justify-end gap-4">
            ...
            @else
                <a href="{{ url('/petani') }}" class="inline-block px-5 py-1.5 text-emerald-600 dark:text-emerald-400 font-bold hover:underline rounded-sm text-sm leading-normal">
                    🌾 Masuk Petani
                </a>
    
                <a href="{{ url('/admin') }}" class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">
                    Portal Admin 🛡️
                </a>
            @endauth
        </nav>
